...
def get_tokenizer_and_model(model_type, eval_mode=True):
    assert model_type in ('bert', 'clip','biobert')
    if model_type == 'bert':
        text_tokenizer = DistilBertTokenizer.from_pretrained('distilbert-base-uncased')
        text_model = DistilBertModel.from_pretrained('distilbert-base-uncased')
    elif model_type == 'biobert':
        text_tokenizer = AutoTokenizer.from_pretrained("medicalai/ClinicalBERT")
        text_model = AutoModel.from_pretrained("medicalai/ClinicalBERT")
