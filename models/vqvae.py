...
class VQVAE(nn.Module):
    def __init__(self, im_channels, down_channels, mid_channels, down_sample, num_down_layers, num_mid_layers,
                 num_up_layers,
                 attns, z_channels, codebook_size, norm_channels, num_heads):
        super().__init__()
